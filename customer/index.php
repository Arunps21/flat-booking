        ...
        <main>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">
                        <strong><span>IDEAL</span>HOMES</strong>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="dp1.php">Category</a>
                            </li>
            ...
            <section class="slick-slideshow">   
                <div class="slick-custom">
                    <img src="images/slideshow/home1.jpeg" class="img-fluid" alt=""> 

                    <div class="slick-bottom">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    <h1 class="slick-title">WELCOME TO IDEAL HOMES</h1>

                                    <p class="lead text-white mt-lg-3 mb-lg-5"><b>It's so good to be home....!</b></p>
                ...
                <div class="slick-custom">
                    <img src="images/slideshow/home2.jpeg" class="img-fluid" alt="">

                    <div class="slick-bottom">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    <h1 class="slick-title">OUR HOMES</h1>

                                    <p class="lead text-white mt-lg-3 mb-lg-5"><b>Live, Laugh, Love Your Home</b></p>
                ...
                <div class="slick-custom">
                    <img src="images/slideshow/home3.jpeg" class="img-fluid" alt="">

                    <div class="slick-bottom">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    <h1 class="slick-title">ENJOY </h1>

                                    <p class="lead text-white mt-lg-3 mb-lg-5"><b>We are so happy to make your dream come true.... </b></p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="mb-5">“There is nothing more important than a good, safe, secure home.”<span></span> </h2>
                        </div>
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="images/slideshow/home4.jpeg" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <p><b>“Home is a place you grow up wanting to leave, and grow old wanting to get back to.” “There's no place like home.” “Where we love is home- home that our feet may leave, but not our hearts.”.</b></p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-10 me-auto mb-4">
                        ...
                        <p class="copyright-text text-muted mt-lg-5 mb-4 mb-lg-0">Idealflats@gmail.com <strong></strong></p>
